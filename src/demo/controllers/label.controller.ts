...
export class LabelsController {
    ...
    @Post(':id')
    async createContact(@Param('id') id:string, @Body() body:Label): Promise<any>{
        return this.repository.updateLabels(body,id)
    }

    @Put(':id/:key')
    async updateContact(@Param('id') id:string, @Param('key') key:string, @Body() body:Label): Promise<any>{
